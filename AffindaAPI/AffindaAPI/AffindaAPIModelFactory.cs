...
namespace Affinda.API.Models
{
    ...
    public static partial class AffindaAPIModelFactory
    {
        ...
        public static Paths1Sikw07V2IndexPostResponses201ContentApplicationJsonSchema Paths1Sikw07V2IndexPostResponses201ContentApplicationJsonSchema(string name = null, Enum5? documentType = null)
        {
        ...
        /// <returns> A new <see cref="Models.Paths14R8PdgV2IndexNameDocumentsPostResponses201ContentApplicationJsonSchema"/> instance for mocking. </returns>
        public static Paths14R8PdgV2IndexNameDocumentsPostResponses201ContentApplicationJsonSchema Paths14R8PdgV2IndexNameDocumentsPostResponses201ContentApplicationJsonSchema(string document = null)
        {
            return new Paths14R8PdgV2IndexNameDocumentsPostResponses201ContentApplicationJsonSchema(document);
        }
        ...
        /// <param name="previous"> URL to request previous page of results. </param>
        /// <param name="results"></param>
        /// <returns> A new <see cref="Models.PathsMda0LlV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchema"/> instance for mocking. </returns>
        public static PathsMda0LlV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchema PathsMda0LlV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchema(int count = default, string next = null, string previous = null, IEnumerable<ResthookSubscription> results = null)
        {
            results ??= new List<ResthookSubscription>();

            return new PathsMda0LlV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchema(count, next, previous, results?.ToList());
        }
        ...
        /// <param name="results"></param>
        /// <returns> A new <see cref="Models.PathsDd1FapV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchemaAllof1"/> instance for mocking. </returns>
        public static PathsDd1FapV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchemaAllof1 PathsDd1FapV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchemaAllof1(IEnumerable<ResthookSubscription> results = null)
        {
            results ??= new List<ResthookSubscription>();

            return new PathsDd1FapV2ResthookSubscriptionsGetResponses200ContentApplicationJsonSchemaAllof1(results?.ToList());
        }
