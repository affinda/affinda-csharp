...
namespace Affinda.API
{
    internal partial class AffindaAPIRestClient
    {
        ...
        internal HttpMessage CreateCreateDocumentRequest(Stream file, string url, string data, string collection, string workspace, string wait, string identifier, string customIdentifier, string fileName, string expiryTime, string language, string rejectDuplicates, string regionBias, string lowPriority, string compact, string deleteAfterParse, string enableValidationTool)
        {
            ...
            if (compact != null)
            {
                content.Add(new StringRequestContent(compact), "compact", null);
            }
            if (deleteAfterParse != null)
            {
        ...
        internal HttpMessage CreateGetAllValidationResultsRequest(string document, int? offset, int? limit)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            uri.AppendRaw(_region.Value.ToString(), true);
            uri.AppendRaw(".affinda.com", false);
            uri.AppendPath("/v3/validation_results", false);
            if (offset != null)
            {
                uri.AppendQuery("offset", offset.Value, true);
            }
        ...
        public async Task<Response<IReadOnlyList<ValidationResult>>> GetAllValidationResultsAsync(string document, int? offset = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            if (document == null)
            {
            ...
            using var message = CreateGetAllValidationResultsRequest(document, offset, limit);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        ...
                        foreach (var item in document0.RootElement.EnumerateArray())
                        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="document"/> is null. </exception>
        /// <remarks> Returns the validation results of a document. </remarks>
        public Response<IReadOnlyList<ValidationResult>> GetAllValidationResults(string document, int? offset = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            if (document == null)
            {
                throw new ArgumentNullException(nameof(document));
        ...
        internal HttpMessage CreateCreateValidationResultRequest(ValidationResultCreate body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        public async Task<Response<ValidationResult>> CreateValidationResultAsync(ValidationResultCreate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
            ...
            using var message = CreateCreateValidationResultRequest(body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 201:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <remarks> Create a validation result. </remarks>
        public Response<ValidationResult> CreateValidationResult(ValidationResultCreate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        internal HttpMessage CreateGetValidationResultRequest(int id)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<ValidationResult>> GetValidationResultAsync(int id, CancellationToken cancellationToken = default)
        {
            using var message = CreateGetValidationResultRequest(id);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Return a specific validation result. </remarks>
        public Response<ValidationResult> GetValidationResult(int id, CancellationToken cancellationToken = default)
        {
            using var message = CreateGetValidationResultRequest(id);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        internal HttpMessage CreateUpdateValidationResultRequest(int id, ValidationResultUpdate body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Patch;
        ...
        public async Task<Response<ValidationResult>> UpdateValidationResultAsync(int id, ValidationResultUpdate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
            ...
            using var message = CreateUpdateValidationResultRequest(id, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <remarks> Update a validation result. </remarks>
        public Response<ValidationResult> UpdateValidationResult(int id, ValidationResultUpdate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        internal HttpMessage CreateDeleteValidationResultRequest(int id)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        public async Task<Response> DeleteValidationResultAsync(int id, CancellationToken cancellationToken = default)
        {
            using var message = CreateDeleteValidationResultRequest(id);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Remove validation result. </remarks>
        public Response DeleteValidationResult(int id, CancellationToken cancellationToken = default)
        {
            using var message = CreateDeleteValidationResultRequest(id);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public async Task<Response<AnnotationWithValidationResults>> CreateAnnotationAsync(AnnotationCreate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
            ...
            switch (message.Response.Status)
            {
                case 201:
                    {
                        AnnotationWithValidationResults value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        ...
                        {
                            value = AnnotationWithValidationResults.DeserializeAnnotationWithValidationResults(document.RootElement);
                        }
                        return Response.FromValue(value, message.Response);
                    }
                default:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public Response<AnnotationWithValidationResults> CreateAnnotation(AnnotationCreate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        public async Task<Response<AnotationDelete>> DeleteAnnotationAsync(int id, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        AnotationDelete value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = AnotationDelete.DeserializeAnotationDelete(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await ClientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Deletes the specified annotation from the database. </remarks>
        public Response<AnotationDelete> DeleteAnnotation(int id, CancellationToken cancellationToken = default)
        {
            using var message = CreateDeleteAnnotationRequest(id);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public async Task<Response<BatchDeleteAnnotationsResponse>> BatchDeleteAnnotationsAsync(IEnumerable<int> body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        BatchDeleteAnnotationsResponse value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = BatchDeleteAnnotationsResponse.DeserializeBatchDeleteAnnotationsResponse(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await ClientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public Response<BatchDeleteAnnotationsResponse> BatchDeleteAnnotations(IEnumerable<int> body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        internal HttpMessage CreateCreateMappingDataSourceRequest(MappingDataSourceCreate body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        public async Task<Response<MappingDataSource>> CreateMappingDataSourceAsync(MappingDataSourceCreate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
            ...
            using var message = CreateCreateMappingDataSourceRequest(body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 201:
                    {
                        MappingDataSource value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = MappingDataSource.DeserializeMappingDataSource(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await ClientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <remarks> Create a custom mapping data source. </remarks>
        public Response<MappingDataSource> CreateMappingDataSource(MappingDataSourceCreate body, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
                throw new ArgumentNullException(nameof(body));
        ...
        public async Task<Response<MappingDataSource>> GetMappingDataSourceAsync(string identifier, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
            ...
            using var message = CreateGetMappingDataSourceRequest(identifier);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> is null. </exception>
        /// <remarks> Return a specific mapping data source. </remarks>
        public Response<MappingDataSource> GetMappingDataSource(string identifier, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
        ...
        internal HttpMessage CreateDeleteMappingDataSourceRequest(string identifier)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        public async Task<Response> DeleteMappingDataSourceAsync(string identifier, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
            ...
            using var message = CreateDeleteMappingDataSourceRequest(identifier);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> is null. </exception>
        /// <remarks> Delete the specified mapping data source from the database. </remarks>
        public Response DeleteMappingDataSource(string identifier, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
        ...
        public async Task<Response<Paths1Qr7BnyV3MappingDataSourcesIdentifierValuesGetResponses200ContentApplicationJsonSchema>> ListMappingDataSourceValuesAsync(string identifier, int? limit = null, int? offset = null, string search = null, int? annotation = null, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        Paths1Qr7BnyV3MappingDataSourcesIdentifierValuesGetResponses200ContentApplicationJsonSchema value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = Paths1Qr7BnyV3MappingDataSourcesIdentifierValuesGetResponses200ContentApplicationJsonSchema.DeserializePaths1Qr7BnyV3MappingDataSourcesIdentifierValuesGetResponses200ContentApplicationJsonSchema(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await ClientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        internal HttpMessage CreateReplaceMappingDataSourceValuesRequest(string identifier, IEnumerable<object> body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response<IReadOnlyList<object>>> ReplaceMappingDataSourceValuesAsync(string identifier, IEnumerable<object> body, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
            ...
            using var message = CreateReplaceMappingDataSourceValuesRequest(identifier, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 201:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> or <paramref name="body"/> is null. </exception>
        /// <remarks> Replaces the list of all values in a mapping data source. </remarks>
        public Response<IReadOnlyList<object>> ReplaceMappingDataSourceValues(string identifier, IEnumerable<object> body, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
        ...
        internal HttpMessage CreateAddMappingDataSourceValueRequest(string identifier, object body)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        public async Task<Response<object>> AddMappingDataSourceValueAsync(string identifier, object body, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
            ...
            using var message = CreateAddMappingDataSourceValueRequest(identifier, body);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 201:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> or <paramref name="body"/> is null. </exception>
        /// <remarks> Adds a value to a mapping data source. </remarks>
        public Response<object> AddMappingDataSourceValue(string identifier, object body, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
        ...
        internal HttpMessage CreateGetMappingDataSourceValueRequest(string identifier, string value)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> or <paramref name="value"/> is null. </exception>
        /// <remarks> Return a specific mapping dta source value. </remarks>
        public async Task<Response<object>> GetMappingDataSourceValueAsync(string identifier, string value, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
            ...
            using var message = CreateGetMappingDataSourceValueRequest(identifier, value);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        object value0 = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value0 = document.RootElement.GetObject();
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> or <paramref name="value"/> is null. </exception>
        /// <remarks> Return a specific mapping dta source value. </remarks>
        public Response<object> GetMappingDataSourceValue(string identifier, string value, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
        ...
        internal HttpMessage CreateDeleteMappingDataSourceValueRequest(string identifier, string value)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Delete;
        ...
        public async Task<Response> DeleteMappingDataSourceValueAsync(string identifier, string value, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
            ...
            using var message = CreateDeleteMappingDataSourceValueRequest(identifier, value);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 204:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="identifier"/> or <paramref name="value"/> is null. </exception>
        /// <remarks> Delete the specified mapping data source value from the database. </remarks>
        public Response DeleteMappingDataSourceValue(string identifier, string value, CancellationToken cancellationToken = default)
        {
            if (identifier == null)
            {
                throw new ArgumentNullException(nameof(identifier));
        ...
        internal HttpMessage CreateGetAllIndexDocumentsRequest(string name, int? offset, int? limit)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<PathsO7SnenV3IndexNameDocumentsGetResponses200ContentApplicationJsonSchema>> GetAllIndexDocumentsAsync(string name, int? offset = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
            ...
            using var message = CreateGetAllIndexDocumentsRequest(name, offset, limit);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        /// <remarks> Returns all the indexed documents for that index. </remarks>
        public Response<PathsO7SnenV3IndexNameDocumentsGetResponses200ContentApplicationJsonSchema> GetAllIndexDocuments(string name, int? offset = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
