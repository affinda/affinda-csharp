...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerBusinessNumber
    {
        internal static InvoiceDataCustomerBusinessNumber DeserializeInvoiceDataCustomerBusinessNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerBusinessNumber(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
