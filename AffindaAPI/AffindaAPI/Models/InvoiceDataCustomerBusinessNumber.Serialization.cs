...
{
    public partial class InvoiceDataCustomerBusinessNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerBusinessNumber DeserializeInvoiceDataCustomerBusinessNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerBusinessNumber(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
