...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerBusinessNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerBusinessNumber DeserializeInvoiceDataCustomerBusinessNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerBusinessNumber(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
