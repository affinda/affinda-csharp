...
namespace Affinda.API.Models
{
    public partial class InvoiceDataInvoiceNumber
    {
        internal static InvoiceDataInvoiceNumber DeserializeInvoiceDataInvoiceNumber(JsonElement element)
        {
            ...
            return new InvoiceDataInvoiceNumber(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
