...
namespace Affinda.API.Models
{
    public partial class InvoiceDataInvoiceNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataInvoiceNumber DeserializeInvoiceDataInvoiceNumber(JsonElement element)
        {
            ...
            return new InvoiceDataInvoiceNumber(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
