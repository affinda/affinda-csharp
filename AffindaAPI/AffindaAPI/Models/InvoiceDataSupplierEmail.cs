...
namespace Affinda.API.Models
{
    ...
    public partial class InvoiceDataSupplierEmail : Annotation
    {
        ...
        internal InvoiceDataSupplierEmail(Rectangle rectangle, int? pageIndex, string raw, string parsed, float confidence, bool isVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties) : base(rectangle, pageIndex, raw, parsed, confidence, isVerified, classification, additionalProperties)
        {
        }
    }
}
