...
namespace Affinda.API.Models
{
    ...
    public partial class ResumeSearchDetailLocationValue : Location
    {
        ...
        internal ResumeSearchDetailLocationValue(string formatted, string postalCode, string state, string country, string countryCode, string rawInput, string streetNumber, string street, string apartmentNumber, string city, bool? match) : base(formatted, postalCode, state, country, countryCode, rawInput, streetNumber, street, apartmentNumber, city)
        {
            Match = match;
        }
