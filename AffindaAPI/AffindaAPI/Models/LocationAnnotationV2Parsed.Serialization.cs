...
namespace Affinda.API.Models
{
    public partial class LocationAnnotationV2Parsed : IUtf8JsonSerializable
    {
        ...
        internal static LocationAnnotationV2Parsed DeserializeLocationAnnotationV2Parsed(JsonElement element)
        {
            ...
            return new LocationAnnotationV2Parsed(formatted.Value, postalCode.Value, state.Value, country.Value, countryCode.Value, rawInput, streetNumber.Value, street.Value, apartmentNumber.Value, city.Value, Optional.ToNullable(latitude), Optional.ToNullable(longitude));
        }
    }
}
