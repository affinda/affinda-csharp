...
{
    /// <summary> The JobTitleAnnotationUpdate. </summary>
    internal partial class JobTitleAnnotationUpdate : AnnotationBase
    {
        /// <summary> Initializes a new instance of JobTitleAnnotationUpdate. </summary>
        internal JobTitleAnnotationUpdate()
        {
        }
