...
{
    public partial class InvoiceDataPaymentReference : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentReference DeserializeInvoiceDataPaymentReference(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentReference(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
