...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentReference
    {
        internal static InvoiceDataPaymentReference DeserializeInvoiceDataPaymentReference(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentReference(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
