...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentReference : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentReference DeserializeInvoiceDataPaymentReference(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentReference(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
