...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerContactName : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerContactName DeserializeInvoiceDataCustomerContactName(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerContactName(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
