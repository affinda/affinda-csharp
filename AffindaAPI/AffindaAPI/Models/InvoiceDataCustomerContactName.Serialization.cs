...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerContactName : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerContactName DeserializeInvoiceDataCustomerContactName(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerContactName(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
