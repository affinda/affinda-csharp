...
{
    public partial class PhoneNumberAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static PhoneNumberAnnotation DeserializePhoneNumberAnnotation(JsonElement element)
        {
            Optional<PhoneNumberAnnotationParsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = PhoneNumberAnnotationParsed.DeserializePhoneNumberAnnotationParsed(property.Value);
                    continue;
                }
            ...
            return new PhoneNumberAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
