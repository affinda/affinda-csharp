...
{
    public partial class InvoiceDataBankSortCode : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankSortCode DeserializeInvoiceDataBankSortCode(JsonElement element)
        {
            ...
            return new InvoiceDataBankSortCode(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
