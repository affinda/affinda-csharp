...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankSortCode : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankSortCode DeserializeInvoiceDataBankSortCode(JsonElement element)
        {
            ...
            return new InvoiceDataBankSortCode(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
