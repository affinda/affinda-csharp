...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankSortCode
    {
        internal static InvoiceDataBankSortCode DeserializeInvoiceDataBankSortCode(JsonElement element)
        {
            ...
            return new InvoiceDataBankSortCode(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
