...
namespace Affinda.API.Models
{
    ...
    public partial class InvoiceDataInvoicePurchaseOrderNumber : Annotation
    {
        ...
        internal InvoiceDataInvoicePurchaseOrderNumber(Rectangle rectangle, int? pageIndex, string raw, float confidence, bool isVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, string parsed) : base(rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties)
        {
            Parsed = parsed;
        }
