...
{
    public partial class InvoiceDataCustomerPhoneNumber
    {
        internal static InvoiceDataCustomerPhoneNumber DeserializeInvoiceDataCustomerPhoneNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerPhoneNumber(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
