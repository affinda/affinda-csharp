...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerPhoneNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerPhoneNumber DeserializeInvoiceDataCustomerPhoneNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerPhoneNumber(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
