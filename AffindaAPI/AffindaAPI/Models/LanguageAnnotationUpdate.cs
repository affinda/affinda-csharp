...
{
    /// <summary> The LanguageAnnotationUpdate. </summary>
    internal partial class LanguageAnnotationUpdate : AnnotationBase
    {
        /// <summary> Initializes a new instance of LanguageAnnotationUpdate. </summary>
        internal LanguageAnnotationUpdate()
        {
        }
