...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierWebsite : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierWebsite DeserializeInvoiceDataSupplierWebsite(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierWebsite(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
