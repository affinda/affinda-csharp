...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierWebsite
    {
        internal static InvoiceDataSupplierWebsite DeserializeInvoiceDataSupplierWebsite(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierWebsite(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
