...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierWebsite
    {
        internal static InvoiceDataSupplierWebsite DeserializeInvoiceDataSupplierWebsite(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierWebsite(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
