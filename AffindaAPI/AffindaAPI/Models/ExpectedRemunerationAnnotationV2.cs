...
namespace Affinda.API.Models
{
    ...
    public partial class ExpectedRemunerationAnnotationV2 : AnnotationV2
    {
        ...
        internal ExpectedRemunerationAnnotationV2(int id, Rectangle rectangle, IReadOnlyList<Rectangle> rectangles, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool isClientVerified, bool isAutoVerified, string dataPoint, string contentType, IReadOnlyDictionary<string, object> additionalProperties, ExpectedRemunerationAnnotationV2Parsed parsed) : base(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties)
        {
            Parsed = parsed;
        }

        /// <summary> Gets the parsed. </summary>
        public ExpectedRemunerationAnnotationV2Parsed Parsed { get; }
    }
}
