...
namespace Affinda.API.Models
{
    public partial class LocationAnnotation
    {
        internal static LocationAnnotation DeserializeLocationAnnotation(JsonElement element)
        {
            ...
            return new LocationAnnotation(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
