...
{
    public partial class LocationAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static LocationAnnotation DeserializeLocationAnnotation(JsonElement element)
        {
            ...
            return new LocationAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
