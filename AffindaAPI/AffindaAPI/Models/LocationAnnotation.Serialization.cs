...
namespace Affinda.API.Models
{
    public partial class LocationAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static LocationAnnotation DeserializeLocationAnnotation(JsonElement element)
        {
            ...
            return new LocationAnnotation(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
