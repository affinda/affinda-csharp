...
{
    public partial class SkillAnnotation
    {
        internal static SkillAnnotation DeserializeSkillAnnotation(JsonElement element)
        {
            ...
            return new SkillAnnotation(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
