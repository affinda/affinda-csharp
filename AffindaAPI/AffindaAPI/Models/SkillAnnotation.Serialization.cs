...
namespace Affinda.API.Models
{
    public partial class SkillAnnotation
    {
        internal static SkillAnnotation DeserializeSkillAnnotation(JsonElement element)
        {
            ...
            return new SkillAnnotation(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
