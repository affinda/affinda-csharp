...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierEmail : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierEmail DeserializeInvoiceDataSupplierEmail(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierEmail(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
