...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierEmail
    {
        internal static InvoiceDataSupplierEmail DeserializeInvoiceDataSupplierEmail(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierEmail(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
