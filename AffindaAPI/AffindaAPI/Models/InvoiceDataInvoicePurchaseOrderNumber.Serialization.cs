...
namespace Affinda.API.Models
{
    public partial class InvoiceDataInvoicePurchaseOrderNumber
    {
        internal static InvoiceDataInvoicePurchaseOrderNumber DeserializeInvoiceDataInvoicePurchaseOrderNumber(JsonElement element)
        {
            ...
            return new InvoiceDataInvoicePurchaseOrderNumber(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
