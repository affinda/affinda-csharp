...
namespace Affinda.API.Models
{
    public partial class InvoiceDataInvoicePurchaseOrderNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataInvoicePurchaseOrderNumber DeserializeInvoiceDataInvoicePurchaseOrderNumber(JsonElement element)
        {
            ...
            return new InvoiceDataInvoicePurchaseOrderNumber(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
