...
namespace Affinda.API.Models
{
    ...
    public partial class DateAnnotation : Annotation
    {
        ...
        internal DateAnnotation(Rectangle rectangle, int? pageIndex, string raw, float confidence, bool isVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, DateTimeOffset? parsed) : base(rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties)
        {
            Parsed = parsed;
        }
