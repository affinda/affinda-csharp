...
namespace Affinda.API.Models
{
    ...
    public partial class DateAnnotation : Annotation
    {
        ...
        internal DateAnnotation(int? id, Rectangle rectangle, int? pageIndex, string raw, float confidence, bool isVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, DateTimeOffset? parsed) : base(id, rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties)
        {
            Parsed = parsed;
        }
