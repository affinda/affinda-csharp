...
{
    public partial class InvoiceDataCustomerCompanyName : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerCompanyName DeserializeInvoiceDataCustomerCompanyName(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerCompanyName(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
