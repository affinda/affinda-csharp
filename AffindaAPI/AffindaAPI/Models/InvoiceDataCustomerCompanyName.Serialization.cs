...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerCompanyName
    {
        internal static InvoiceDataCustomerCompanyName DeserializeInvoiceDataCustomerCompanyName(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerCompanyName(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
