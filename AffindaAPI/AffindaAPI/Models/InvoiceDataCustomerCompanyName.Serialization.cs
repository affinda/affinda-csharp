...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerCompanyName : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerCompanyName DeserializeInvoiceDataCustomerCompanyName(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerCompanyName(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
