...
{
    public partial class InvoiceDataSupplierPhoneNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierPhoneNumber DeserializeInvoiceDataSupplierPhoneNumber(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierPhoneNumber(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
