...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierPhoneNumber
    {
        internal static InvoiceDataSupplierPhoneNumber DeserializeInvoiceDataSupplierPhoneNumber(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierPhoneNumber(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
