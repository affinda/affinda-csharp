...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierPhoneNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierPhoneNumber DeserializeInvoiceDataSupplierPhoneNumber(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierPhoneNumber(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
