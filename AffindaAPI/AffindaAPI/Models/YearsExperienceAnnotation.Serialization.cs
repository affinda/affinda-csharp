...
{
    public partial class YearsExperienceAnnotation
    {
        internal static YearsExperienceAnnotation DeserializeYearsExperienceAnnotation(JsonElement element)
        {
            ...
            return new YearsExperienceAnnotation(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
