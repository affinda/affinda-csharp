...
namespace Affinda.API.Models
{
    public partial class YearsExperienceAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static YearsExperienceAnnotation DeserializeYearsExperienceAnnotation(JsonElement element)
        {
            ...
            return new YearsExperienceAnnotation(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
