...
{
    public partial class YearsExperienceAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static YearsExperienceAnnotation DeserializeYearsExperienceAnnotation(JsonElement element)
        {
            Optional<YearsExperienceAnnotationParsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = YearsExperienceAnnotationParsed.DeserializeYearsExperienceAnnotationParsed(property.Value);
                    continue;
                }
            ...
            return new YearsExperienceAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
