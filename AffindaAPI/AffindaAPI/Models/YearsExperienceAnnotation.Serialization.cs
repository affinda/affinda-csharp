...
namespace Affinda.API.Models
{
    public partial class YearsExperienceAnnotation
    {
        internal static YearsExperienceAnnotation DeserializeYearsExperienceAnnotation(JsonElement element)
        {
            ...
            return new YearsExperienceAnnotation(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
