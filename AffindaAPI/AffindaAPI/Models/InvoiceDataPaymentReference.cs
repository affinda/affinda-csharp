...
namespace Affinda.API.Models
{
    ...
    public partial class InvoiceDataPaymentReference : TextAnnotation
    {
        ...
        internal InvoiceDataPaymentReference(int? id, Rectangle rectangle, int? pageIndex, string raw, float? confidence, bool isVerified, bool? isClientVerified, bool? isAutoVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, string parsed) : base(id, rectangle, pageIndex, raw, confidence, isVerified, isClientVerified, isAutoVerified, classification, additionalProperties, parsed)
        {
        }
    }
}
