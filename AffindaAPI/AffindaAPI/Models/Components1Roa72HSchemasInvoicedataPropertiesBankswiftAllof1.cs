...
{
    /// <summary> The Components1Roa72HSchemasInvoicedataPropertiesBankswiftAllof1. </summary>
    public partial class Components1Roa72HSchemasInvoicedataPropertiesBankswiftAllof1
    {
        ...
        public Components1Roa72HSchemasInvoicedataPropertiesBankswiftAllof1(string raw)
        {
            Raw = raw;
        }
        ...
        internal Components1Roa72HSchemasInvoicedataPropertiesBankswiftAllof1(string raw, string parsed)
        {
            Raw = raw;
            Parsed = parsed;
        }
