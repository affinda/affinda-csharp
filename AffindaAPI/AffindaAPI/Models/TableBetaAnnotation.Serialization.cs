...
{
    public partial class TableBetaAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static TableBetaAnnotation DeserializeTableBetaAnnotation(JsonElement element)
        {
            Optional<TableBetaAnnotationParsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = TableBetaAnnotationParsed.DeserializeTableBetaAnnotationParsed(property.Value);
                    continue;
                }
            ...
            return new TableBetaAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
