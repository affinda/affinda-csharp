...
namespace Affinda.API.Models
{
    ...
    public readonly partial struct DocumentType : IEquatable<DocumentType>
    {
        ...
        public static DocumentType Resumes { get; } = new DocumentType(ResumesValue);
        /// <summary> job_descriptions. </summary>
        public static DocumentType JobDescriptions { get; } = new DocumentType(JobDescriptionsValue);
