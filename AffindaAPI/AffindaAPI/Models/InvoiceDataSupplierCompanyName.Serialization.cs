...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierCompanyName : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierCompanyName DeserializeInvoiceDataSupplierCompanyName(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierCompanyName(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
