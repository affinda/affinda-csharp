...
{
    public partial class InvoiceDataSupplierCompanyName : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierCompanyName DeserializeInvoiceDataSupplierCompanyName(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierCompanyName(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
