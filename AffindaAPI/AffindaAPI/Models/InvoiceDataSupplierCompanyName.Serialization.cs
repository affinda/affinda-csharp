...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierCompanyName
    {
        internal static InvoiceDataSupplierCompanyName DeserializeInvoiceDataSupplierCompanyName(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierCompanyName(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
