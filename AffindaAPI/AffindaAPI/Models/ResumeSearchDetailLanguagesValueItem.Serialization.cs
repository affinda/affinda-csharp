...
{
    public partial class ResumeSearchDetailLanguagesValueItem
    {
        internal static ResumeSearchDetailLanguagesValueItem DeserializeResumeSearchDetailLanguagesValueItem(JsonElement element)
        {
            ...
            return new ResumeSearchDetailLanguagesValueItem(name.Value, lastUsed.Value, Optional.ToNullable(numberOfMonths), type.Value, Optional.ToList(sources), Optional.ToNullable(match));
        }
    }
}
