...
{
    public partial class LocationAnnotationV2UpdateParsed : IUtf8JsonSerializable
    {
        ...
        internal static LocationAnnotationV2UpdateParsed DeserializeLocationAnnotationV2UpdateParsed(JsonElement element)
        {
            ...
            return new LocationAnnotationV2UpdateParsed(formatted.Value, postalCode.Value, state.Value, stateCode.Value, country.Value, countryCode.Value, rawInput, streetNumber.Value, street.Value, apartmentNumber.Value, city.Value, Optional.ToNullable(latitude), Optional.ToNullable(longitude), poBox.Value);
        }
    }
}
