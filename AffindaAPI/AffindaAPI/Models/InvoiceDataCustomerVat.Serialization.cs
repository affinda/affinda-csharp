...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerVat
    {
        internal static InvoiceDataCustomerVat DeserializeInvoiceDataCustomerVat(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerVat(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
