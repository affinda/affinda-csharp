...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerVat : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerVat DeserializeInvoiceDataCustomerVat(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerVat(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
