...
{
    public partial class YearsExperienceAnnotationV2 : IUtf8JsonSerializable
    {
        ...
        internal static YearsExperienceAnnotationV2 DeserializeYearsExperienceAnnotationV2(JsonElement element)
        {
            Optional<YearsExperienceAnnotationV2Parsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = YearsExperienceAnnotationV2Parsed.DeserializeYearsExperienceAnnotationV2Parsed(property.Value);
                    continue;
                }
            ...
            return new YearsExperienceAnnotationV2(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
