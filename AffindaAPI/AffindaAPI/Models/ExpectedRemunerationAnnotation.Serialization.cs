...
namespace Affinda.API.Models
{
    public partial class ExpectedRemunerationAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static ExpectedRemunerationAnnotation DeserializeExpectedRemunerationAnnotation(JsonElement element)
        {
            ...
            return new ExpectedRemunerationAnnotation(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
