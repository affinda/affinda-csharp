...
{
    public partial class LocationAnnotationUpdateParsed : IUtf8JsonSerializable
    {
        ...
        internal static LocationAnnotationUpdateParsed DeserializeLocationAnnotationUpdateParsed(JsonElement element)
        {
            ...
            return new LocationAnnotationUpdateParsed(formatted.Value, postalCode.Value, state.Value, stateCode.Value, country.Value, countryCode.Value, rawInput, streetNumber.Value, street.Value, apartmentNumber.Value, city.Value, Optional.ToNullable(latitude), Optional.ToNullable(longitude), poBox.Value);
        }
    }
}
