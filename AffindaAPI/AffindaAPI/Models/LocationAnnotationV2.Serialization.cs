...
{
    public partial class LocationAnnotationV2 : IUtf8JsonSerializable
    {
        ...
        internal static LocationAnnotationV2 DeserializeLocationAnnotationV2(JsonElement element)
        {
            Optional<LocationAnnotationV2Parsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = LocationAnnotationV2Parsed.DeserializeLocationAnnotationV2Parsed(property.Value);
                    continue;
                }
            ...
            return new LocationAnnotationV2(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
