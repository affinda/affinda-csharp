...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBpayBillerCode
    {
        internal static InvoiceDataBpayBillerCode DeserializeInvoiceDataBpayBillerCode(JsonElement element)
        {
            ...
            return new InvoiceDataBpayBillerCode(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties, parsed.Value);
        }
    }
}
