...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBpayBillerCode : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBpayBillerCode DeserializeInvoiceDataBpayBillerCode(JsonElement element)
        {
            ...
            return new InvoiceDataBpayBillerCode(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
