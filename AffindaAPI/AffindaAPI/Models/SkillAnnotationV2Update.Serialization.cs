...
{
    public partial class SkillAnnotationV2Update : IUtf8JsonSerializable
    {
        ...
        internal static SkillAnnotationV2Update DeserializeSkillAnnotationV2Update(JsonElement element)
        {
