...
{
    public partial class LanguageAnnotationV2Update : IUtf8JsonSerializable
    {
        ...
        internal static LanguageAnnotationV2Update DeserializeLanguageAnnotationV2Update(JsonElement element)
        {
