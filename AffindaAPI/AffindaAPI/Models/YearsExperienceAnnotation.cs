...
namespace Affinda.API.Models
{
    ...
    public partial class YearsExperienceAnnotation : Annotation
    {
        ...
        internal YearsExperienceAnnotation(int? id, Rectangle rectangle, int? pageIndex, string raw, float? confidence, bool isVerified, bool? isClientVerified, bool? isAutoVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, YearsExperienceAnnotationParsed parsed) : base(id, rectangle, pageIndex, raw, confidence, isVerified, isClientVerified, isAutoVerified, classification, additionalProperties)
        {
            Parsed = parsed;
        }
