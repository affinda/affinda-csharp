...
namespace Affinda.API.Models
{
    ...
    public partial class YearsExperienceAnnotation : Annotation
    {
        ...
        internal YearsExperienceAnnotation(int? id, Rectangle rectangle, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool? isClientVerified, bool? isAutoVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, YearsExperienceAnnotationParsed parsed) : base(id, rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, classification, additionalProperties)
        {
            Parsed = parsed;
        }
