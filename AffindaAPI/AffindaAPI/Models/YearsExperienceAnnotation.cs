...
namespace Affinda.API.Models
{
    ...
    public partial class YearsExperienceAnnotation : Annotation
    {
        ...
        internal YearsExperienceAnnotation(int id, Rectangle rectangle, IList<Rectangle> rectangles, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool isClientVerified, bool isAutoVerified, string dataPoint, string contentType, IDictionary<string, object> additionalProperties, YearsExperienceAnnotationParsed parsed) : base(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties)
        {
            Parsed = parsed;
        }

        /// <summary> Years of experience range. </summary>
        public YearsExperienceAnnotationParsed Parsed { get; set; }
    }
}
