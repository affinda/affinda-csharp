...
{
    public partial class DateAnnotationV2 : IUtf8JsonSerializable
    {
        ...
        internal static DateAnnotationV2 DeserializeDateAnnotationV2(JsonElement element)
        {
            ...
            return new DateAnnotationV2(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, Optional.ToNullable(parsed));
        }
    }
}
