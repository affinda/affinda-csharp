...
namespace Affinda.API.Models
{
    public partial class Field : IUtf8JsonSerializable
    {
        ...
        internal static Field DeserializeField(JsonElement element)
        {
            ...
            return new Field(label, slug.Value, dataPoint, Optional.ToNullable(mandatory), Optional.ToNullable(disabled), Optional.ToNullable(autoValidationThreshold), Optional.ToNullable(showDropdown), Optional.ToList(fields));
        }
    }
}
