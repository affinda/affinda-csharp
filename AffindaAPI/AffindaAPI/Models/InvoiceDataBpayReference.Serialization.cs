...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBpayReference
    {
        internal static InvoiceDataBpayReference DeserializeInvoiceDataBpayReference(JsonElement element)
        {
            ...
            return new InvoiceDataBpayReference(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
