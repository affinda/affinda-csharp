...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBpayReference
    {
        internal static InvoiceDataBpayReference DeserializeInvoiceDataBpayReference(JsonElement element)
        {
            ...
            return new InvoiceDataBpayReference(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
