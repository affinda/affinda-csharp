...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBpayReference : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBpayReference DeserializeInvoiceDataBpayReference(JsonElement element)
        {
            ...
            return new InvoiceDataBpayReference(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
