...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBpayReference : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBpayReference DeserializeInvoiceDataBpayReference(JsonElement element)
        {
            ...
            return new InvoiceDataBpayReference(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
