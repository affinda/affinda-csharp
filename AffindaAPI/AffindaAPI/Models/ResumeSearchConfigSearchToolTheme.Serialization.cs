...
{
    public partial class ResumeSearchConfigSearchToolTheme : IUtf8JsonSerializable
    {
        ...
        internal static ResumeSearchConfigSearchToolTheme DeserializeResumeSearchConfigSearchToolTheme(JsonElement element)
        {
            ...
            return new ResumeSearchConfigSearchToolTheme(palette.Value, typography.Value, Optional.ToNullable(borderRadius), fontUrl.Value);
        }
    }
}
