...
namespace Affinda.API.Models
{
    public partial class JobTitleAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static JobTitleAnnotation DeserializeJobTitleAnnotation(JsonElement element)
        {
            ...
            return new JobTitleAnnotation(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
