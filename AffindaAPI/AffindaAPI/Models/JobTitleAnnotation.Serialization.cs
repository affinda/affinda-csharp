...
{
    public partial class JobTitleAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static JobTitleAnnotation DeserializeJobTitleAnnotation(JsonElement element)
        {
            ...
            return new JobTitleAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
