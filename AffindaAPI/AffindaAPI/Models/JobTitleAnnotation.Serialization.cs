...
{
    public partial class JobTitleAnnotation
    {
        internal static JobTitleAnnotation DeserializeJobTitleAnnotation(JsonElement element)
        {
            Optional<JobTitleAnnotationParsed> parsed = default;
            ...
            return new JobTitleAnnotation(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
