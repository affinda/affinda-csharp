...
namespace Affinda.API.Models
{
    public partial class CurrencyCodeAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static CurrencyCodeAnnotation DeserializeCurrencyCodeAnnotation(JsonElement element)
        {
            ...
            return new CurrencyCodeAnnotation(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
