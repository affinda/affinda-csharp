...
{
    public partial class CurrencyCodeAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static CurrencyCodeAnnotation DeserializeCurrencyCodeAnnotation(JsonElement element)
        {
            Optional<DataPointChoice> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = DataPointChoice.DeserializeDataPointChoice(property.Value);
                    continue;
                }
            ...
            return new CurrencyCodeAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
