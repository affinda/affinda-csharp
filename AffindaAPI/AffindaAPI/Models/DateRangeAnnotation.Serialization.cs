...
{
    public partial class DateRangeAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static DateRangeAnnotation DeserializeDateRangeAnnotation(JsonElement element)
        {
            Optional<DateRangeAnnotationParsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = DateRangeAnnotationParsed.DeserializeDateRangeAnnotationParsed(property.Value);
                    continue;
                }
            ...
            return new DateRangeAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
