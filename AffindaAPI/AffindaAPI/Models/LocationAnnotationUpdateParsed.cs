...
namespace Affinda.API.Models
{
    ...
    public partial class LocationAnnotationUpdateParsed : Location
    {
        ...
        internal LocationAnnotationUpdateParsed(string formatted, string postalCode, string state, string country, string countryCode, string rawInput, string streetNumber, string street, string apartmentNumber, string city, float? latitude, float? longitude) : base(formatted, postalCode, state, country, countryCode, rawInput, streetNumber, street, apartmentNumber, city, latitude, longitude)
        {
        }
    }
}
