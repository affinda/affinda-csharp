...
namespace Affinda.API.Models
{
    ...
    public partial class JobTitleAnnotation : Annotation
    {
        ...
        internal JobTitleAnnotation(Rectangle rectangle, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, string classification) : base(rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, classification)
        {
        ...
        internal JobTitleAnnotation(int? id, Rectangle rectangle, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool? isClientVerified, bool? isAutoVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, JobTitleAnnotationParsed parsed) : base(id, rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, classification, additionalProperties)
        {
            Parsed = parsed;
        }
