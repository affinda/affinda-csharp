...
namespace Affinda.API.Models
{
    public partial class EnumAnnotationSerializer
    {
        internal static EnumAnnotationSerializer DeserializeEnumAnnotationSerializer(JsonElement element)
        {
            ...
            return new EnumAnnotationSerializer(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties, parsed.Value);
        }
    }
}
