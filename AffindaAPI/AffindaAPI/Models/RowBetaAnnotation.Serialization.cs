...
{
    public partial class RowBetaAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static RowBetaAnnotation DeserializeRowBetaAnnotation(JsonElement element)
        {
            Optional<RowBetaAnnotationParsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = RowBetaAnnotationParsed.DeserializeRowBetaAnnotationParsed(property.Value);
                    continue;
                }
            ...
            return new RowBetaAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
