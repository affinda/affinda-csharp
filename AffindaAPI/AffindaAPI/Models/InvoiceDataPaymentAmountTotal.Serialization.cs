...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountTotal
    {
        internal static InvoiceDataPaymentAmountTotal DeserializeInvoiceDataPaymentAmountTotal(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountTotal(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
