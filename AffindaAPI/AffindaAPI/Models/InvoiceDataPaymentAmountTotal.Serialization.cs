...
{
    public partial class InvoiceDataPaymentAmountTotal : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountTotal DeserializeInvoiceDataPaymentAmountTotal(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountTotal(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
