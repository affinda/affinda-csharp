...
{
    /// <summary> The PhoneNumberAnnotation. </summary>
    public partial class PhoneNumberAnnotation : Annotation
    {
        /// <summary> Initializes a new instance of PhoneNumberAnnotation. </summary>
        ...
        internal PhoneNumberAnnotation(int id, Rectangle rectangle, IList<Rectangle> rectangles, string document, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool isClientVerified, bool isAutoVerified, string dataPoint, AnnotationContentType contentType, int? parent, IDictionary<string, object> additionalProperties, PhoneNumberAnnotationParsed parsed) : base(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, parent, additionalProperties)
        {
            Parsed = parsed;
        }

        /// <summary> Gets or sets the parsed. </summary>
        public PhoneNumberAnnotationParsed Parsed { get; set; }
    }
}
