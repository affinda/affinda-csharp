...
{
    /// <summary> The SkillAnnotationUpdate. </summary>
    internal partial class SkillAnnotationUpdate : AnnotationBase
    {
        /// <summary> Initializes a new instance of SkillAnnotationUpdate. </summary>
        internal SkillAnnotationUpdate()
        {
        }
