...
namespace Affinda.API.Models
{
    ...
    public partial class InvoiceDataSupplierVAT : Annotation
    {
        ...
        internal InvoiceDataSupplierVAT(Rectangle rectangle, int? pageIndex, string raw, float confidence, bool isVerified, string classification, IReadOnlyDictionary<string, object> additionalProperties, string parsed) : base(rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties)
        {
            Parsed = parsed;
        }
