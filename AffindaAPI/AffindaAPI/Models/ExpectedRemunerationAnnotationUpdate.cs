...
{
    /// <summary> The ExpectedRemunerationAnnotationUpdate. </summary>
    internal partial class ExpectedRemunerationAnnotationUpdate : AnnotationBase
    {
        /// <summary> Initializes a new instance of ExpectedRemunerationAnnotationUpdate. </summary>
        internal ExpectedRemunerationAnnotationUpdate()
        {
        }
        ...
        internal ExpectedRemunerationAnnotationUpdate(int? id, Rectangle rectangle, IReadOnlyList<Rectangle> rectangles, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool? isVerified, bool? isClientVerified, bool? isAutoVerified, string dataPoint, string contentType, IReadOnlyDictionary<string, object> additionalProperties, ExpectedRemunerationAnnotationUpdateParsed parsed) : base(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties)
        {
            Parsed = parsed;
        }

        /// <summary> Gets the parsed. </summary>
        public ExpectedRemunerationAnnotationUpdateParsed Parsed { get; }
    }
}
