...
namespace Affinda.API.Models
{
    public partial class RowAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static RowAnnotation DeserializeRowAnnotation(JsonElement element)
        {
            ...
            return new RowAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
