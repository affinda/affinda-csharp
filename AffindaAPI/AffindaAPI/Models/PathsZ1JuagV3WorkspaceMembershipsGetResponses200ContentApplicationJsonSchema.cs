...
namespace Affinda.API.Models
{
    ...
    public partial class PathsZ1JuagV3WorkspaceMembershipsGetResponses200ContentApplicationJsonSchema : ListResult
    {
        ...
        internal PathsZ1JuagV3WorkspaceMembershipsGetResponses200ContentApplicationJsonSchema(int count, IEnumerable<WorkspaceMembership> results) : base(count)
        {
            if (results == null)
            {
        ...
        /// <param name="results"></param>
        internal PathsZ1JuagV3WorkspaceMembershipsGetResponses200ContentApplicationJsonSchema(int count, string next, string previous, IReadOnlyList<WorkspaceMembership> results) : base(count, next, previous)
        {
            Results = results;
        }
