...
{
    public partial class ExpectedRemunerationAnnotationV2Update : IUtf8JsonSerializable
    {
        ...
        internal static ExpectedRemunerationAnnotationV2Update DeserializeExpectedRemunerationAnnotationV2Update(JsonElement element)
        {
            Optional<ExpectedRemunerationAnnotationV2UpdateParsed> parsed = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = ExpectedRemunerationAnnotationV2UpdateParsed.DeserializeExpectedRemunerationAnnotationV2UpdateParsed(property.Value);
                    continue;
                }
