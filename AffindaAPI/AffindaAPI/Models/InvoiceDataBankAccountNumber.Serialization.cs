...
{
    public partial class InvoiceDataBankAccountNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankAccountNumber DeserializeInvoiceDataBankAccountNumber(JsonElement element)
        {
            ...
            return new InvoiceDataBankAccountNumber(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
