...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankAccountNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankAccountNumber DeserializeInvoiceDataBankAccountNumber(JsonElement element)
        {
            ...
            return new InvoiceDataBankAccountNumber(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
