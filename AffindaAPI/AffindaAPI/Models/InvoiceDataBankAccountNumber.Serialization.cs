...
{
    public partial class InvoiceDataBankAccountNumber
    {
        internal static InvoiceDataBankAccountNumber DeserializeInvoiceDataBankAccountNumber(JsonElement element)
        {
            ...
            return new InvoiceDataBankAccountNumber(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
