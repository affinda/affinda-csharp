...
{
    public partial class LocationAnnotationV2Update : IUtf8JsonSerializable
    {
        ...
        internal static LocationAnnotationV2Update DeserializeLocationAnnotationV2Update(JsonElement element)
        {
            Optional<LocationAnnotationV2UpdateParsed> parsed = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = LocationAnnotationV2UpdateParsed.DeserializeLocationAnnotationV2UpdateParsed(property.Value);
                    continue;
                }
