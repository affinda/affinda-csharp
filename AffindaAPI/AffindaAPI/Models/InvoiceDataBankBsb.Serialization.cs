...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankBsb
    {
        internal static InvoiceDataBankBsb DeserializeInvoiceDataBankBsb(JsonElement element)
        {
            ...
            return new InvoiceDataBankBsb(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
