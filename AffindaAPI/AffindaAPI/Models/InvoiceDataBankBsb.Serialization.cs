...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankBsb : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankBsb DeserializeInvoiceDataBankBsb(JsonElement element)
        {
            ...
            return new InvoiceDataBankBsb(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
