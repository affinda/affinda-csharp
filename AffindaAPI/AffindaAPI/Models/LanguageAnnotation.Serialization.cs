...
namespace Affinda.API.Models
{
    public partial class LanguageAnnotation
    {
        internal static LanguageAnnotation DeserializeLanguageAnnotation(JsonElement element)
        {
            ...
            return new LanguageAnnotation(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
