...
namespace Affinda.API.Models
{
    public partial class LanguageAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static LanguageAnnotation DeserializeLanguageAnnotation(JsonElement element)
        {
            ...
            return new LanguageAnnotation(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
