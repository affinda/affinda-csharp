...
namespace Affinda.API.Models
{
    public partial class LanguageAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static LanguageAnnotation DeserializeLanguageAnnotation(JsonElement element)
        {
            ...
            return new LanguageAnnotation(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
