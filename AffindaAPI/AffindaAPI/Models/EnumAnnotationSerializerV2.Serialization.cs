...
{
    public partial class EnumAnnotationSerializerV2
    {
        internal static EnumAnnotationSerializerV2 DeserializeEnumAnnotationSerializerV2(JsonElement element)
        {
            ...
            return new EnumAnnotationSerializerV2(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
