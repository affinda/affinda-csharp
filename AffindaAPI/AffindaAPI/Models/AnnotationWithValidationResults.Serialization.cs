...
{
    public partial class AnnotationWithValidationResults : IUtf8JsonSerializable
    {
        ...
        internal static AnnotationWithValidationResults DeserializeAnnotationWithValidationResults(JsonElement element)
        {
            Optional<IList<ValidationResult>> validationResults = default;
            int id = default;
            ...
            return new AnnotationWithValidationResults(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, Optional.ToList(validationResults));
        }
    }
}
