...
{
    /// <summary> The PathsWjaaeuUsersGetResponses200ContentApplicationJsonSchema. </summary>
    public partial class PathsWjaaeuUsersGetResponses200ContentApplicationJsonSchema
    {
        ...
        internal PathsWjaaeuUsersGetResponses200ContentApplicationJsonSchema()
        {
        ...
        internal PathsWjaaeuUsersGetResponses200ContentApplicationJsonSchema(int? count, string next, string previous, IReadOnlyList<User> results)
        {
            Count = count;
            Next = next;
            Previous = previous;
