...
{
    public partial class TextAnnotationV2 : IUtf8JsonSerializable
    {
        ...
        internal static TextAnnotationV2 DeserializeTextAnnotationV2(JsonElement element)
        {
            ...
            return new TextAnnotationV2(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
