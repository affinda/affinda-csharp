...
{
    public partial class JobDescriptionSearchConfigSearchToolTheme : IUtf8JsonSerializable
    {
        ...
        internal static JobDescriptionSearchConfigSearchToolTheme DeserializeJobDescriptionSearchConfigSearchToolTheme(JsonElement element)
        {
            ...
            return new JobDescriptionSearchConfigSearchToolTheme(palette.Value, typography.Value, Optional.ToNullable(borderRadius), fontUrl.Value);
        }
    }
}
