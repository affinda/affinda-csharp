...
{
    /// <summary> The Components1OmsnpSchemasInvoicedataPropertiesBpayreferenceAllof2. </summary>
    public partial class Components1OmsnpSchemasInvoicedataPropertiesBpayreferenceAllof2
    {
        ...
        internal Components1OmsnpSchemasInvoicedataPropertiesBpayreferenceAllof2()
        {
        }
        ...
        internal Components1OmsnpSchemasInvoicedataPropertiesBpayreferenceAllof2(string raw, string parsed)
        {
            Raw = raw;
            Parsed = parsed;
        }
