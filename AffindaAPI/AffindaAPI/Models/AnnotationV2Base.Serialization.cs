...
{
    public partial class AnnotationV2Base : IUtf8JsonSerializable
    {
        ...
        internal static AnnotationV2Base DeserializeAnnotationV2Base(JsonElement element)
        {
            ...
            return new AnnotationV2Base(Optional.ToNullable(id), rectangle.Value, Optional.ToList(rectangles), Optional.ToNullable(pageIndex), raw.Value, Optional.ToNullable(confidence), Optional.ToNullable(classificationConfidence), Optional.ToNullable(textExtractionConfidence), Optional.ToNullable(isVerified), Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), dataPoint.Value, contentType.Value, additionalProperties);
        }
    }
}
