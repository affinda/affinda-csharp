...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountBase : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountBase DeserializeInvoiceDataPaymentAmountBase(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountBase(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
