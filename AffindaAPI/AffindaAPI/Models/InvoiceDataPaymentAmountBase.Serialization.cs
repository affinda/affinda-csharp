...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountBase
    {
        internal static InvoiceDataPaymentAmountBase DeserializeInvoiceDataPaymentAmountBase(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountBase(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
