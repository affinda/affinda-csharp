...
{
    public partial class InvoiceDataPaymentAmountPaid
    {
        internal static InvoiceDataPaymentAmountPaid DeserializeInvoiceDataPaymentAmountPaid(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountPaid(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
