...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountPaid : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountPaid DeserializeInvoiceDataPaymentAmountPaid(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountPaid(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
