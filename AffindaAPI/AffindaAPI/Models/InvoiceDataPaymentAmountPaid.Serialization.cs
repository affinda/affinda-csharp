...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountPaid : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountPaid DeserializeInvoiceDataPaymentAmountPaid(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountPaid(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
