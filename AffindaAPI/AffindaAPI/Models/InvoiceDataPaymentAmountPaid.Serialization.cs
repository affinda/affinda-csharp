...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountPaid
    {
        internal static InvoiceDataPaymentAmountPaid DeserializeInvoiceDataPaymentAmountPaid(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountPaid(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties, parsed.Value);
        }
    }
}
