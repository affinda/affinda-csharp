...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankIban : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankIban DeserializeInvoiceDataBankIban(JsonElement element)
        {
            ...
            return new InvoiceDataBankIban(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
