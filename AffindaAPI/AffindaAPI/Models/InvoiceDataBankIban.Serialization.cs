...
{
    public partial class InvoiceDataBankIban : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankIban DeserializeInvoiceDataBankIban(JsonElement element)
        {
            ...
            return new InvoiceDataBankIban(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
