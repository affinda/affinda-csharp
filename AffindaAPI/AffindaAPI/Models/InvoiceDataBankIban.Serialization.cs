...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankIban
    {
        internal static InvoiceDataBankIban DeserializeInvoiceDataBankIban(JsonElement element)
        {
            ...
            return new InvoiceDataBankIban(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
