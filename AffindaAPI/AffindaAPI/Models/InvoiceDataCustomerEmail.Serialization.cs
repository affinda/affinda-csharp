...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerEmail : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerEmail DeserializeInvoiceDataCustomerEmail(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerEmail(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
