...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerEmail
    {
        internal static InvoiceDataCustomerEmail DeserializeInvoiceDataCustomerEmail(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerEmail(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
