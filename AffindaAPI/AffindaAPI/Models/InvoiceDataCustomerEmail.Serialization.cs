...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerEmail : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerEmail DeserializeInvoiceDataCustomerEmail(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerEmail(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
