...
{
    /// <summary> The AnnotationWithValidationResults. </summary>
    public partial class AnnotationWithValidationResults : Annotation
    {
        /// <summary> Initializes a new instance of AnnotationWithValidationResults. </summary>
        ...
        public AnnotationWithValidationResults(int id, Rectangle rectangle, IEnumerable<Rectangle> rectangles, string document, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool isClientVerified, bool isAutoVerified, string dataPoint, AnnotationContentType contentType) : base(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType)
        {
            ...
            ValidationResults = new ChangeTrackingList<ValidationResult>();
        }
        ...
        /// <param name="validationResults"> List of validation results for this annotation. </param>
        internal AnnotationWithValidationResults(int id, Rectangle rectangle, IList<Rectangle> rectangles, string document, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool isClientVerified, bool isAutoVerified, string dataPoint, AnnotationContentType contentType, int? parent, IDictionary<string, object> additionalProperties, IList<ValidationResult> validationResults) : base(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, parent, additionalProperties)
        {
            ValidationResults = validationResults;
        }

        /// <summary> List of validation results for this annotation. </summary>
