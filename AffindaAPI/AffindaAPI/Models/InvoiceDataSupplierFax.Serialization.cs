...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierFax : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierFax DeserializeInvoiceDataSupplierFax(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierFax(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
