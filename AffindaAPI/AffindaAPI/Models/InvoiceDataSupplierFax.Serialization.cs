...
{
    public partial class InvoiceDataSupplierFax
    {
        internal static InvoiceDataSupplierFax DeserializeInvoiceDataSupplierFax(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierFax(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
