...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierFax
    {
        internal static InvoiceDataSupplierFax DeserializeInvoiceDataSupplierFax(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierFax(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
