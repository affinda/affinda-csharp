...
{
    public partial class JobDescriptionSearchConfig : IUtf8JsonSerializable
    {
        ...
        internal static JobDescriptionSearchConfig DeserializeJobDescriptionSearchConfig(JsonElement element)
        {
