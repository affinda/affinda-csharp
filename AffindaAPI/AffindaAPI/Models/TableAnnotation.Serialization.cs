...
namespace Affinda.API.Models
{
    public partial class TableAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static TableAnnotation DeserializeTableAnnotation(JsonElement element)
        {
            ...
            return new TableAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
