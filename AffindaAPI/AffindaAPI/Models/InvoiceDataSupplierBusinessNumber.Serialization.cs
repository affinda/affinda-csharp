...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierBusinessNumber
    {
        internal static InvoiceDataSupplierBusinessNumber DeserializeInvoiceDataSupplierBusinessNumber(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierBusinessNumber(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
