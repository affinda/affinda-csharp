...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierBusinessNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierBusinessNumber DeserializeInvoiceDataSupplierBusinessNumber(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierBusinessNumber(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
