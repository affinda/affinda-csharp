...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierBusinessNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierBusinessNumber DeserializeInvoiceDataSupplierBusinessNumber(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierBusinessNumber(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
