...
namespace Affinda.API.Models
{
    public partial class TextAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static TextAnnotation DeserializeTextAnnotation(JsonElement element)
        {
            ...
            return new TextAnnotation(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
