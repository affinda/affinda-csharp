...
{
    public partial class TextAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static TextAnnotation DeserializeTextAnnotation(JsonElement element)
        {
            ...
            return new TextAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
