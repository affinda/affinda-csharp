...
namespace Affinda.API.Models
{
    public partial class TextAnnotation
    {
        internal static TextAnnotation DeserializeTextAnnotation(JsonElement element)
        {
            ...
            return new TextAnnotation(Optional.ToNullable(id), rectangle, Optional.ToList(rectangles), pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
