...
{
    /// <summary> The ApiUserWithoutKeyOrganizationsItem. </summary>
    public partial class ApiUserWithoutKeyOrganizationsItem
    {
        ...
        internal ApiUserWithoutKeyOrganizationsItem(string identifier, string name)
        {
            if (identifier == null)
            {
