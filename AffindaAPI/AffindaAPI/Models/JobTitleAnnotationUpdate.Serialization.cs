...
{
    public partial class JobTitleAnnotationUpdate : IUtf8JsonSerializable
    {
        ...
        internal static JobTitleAnnotationUpdate DeserializeJobTitleAnnotationUpdate(JsonElement element)
        {
