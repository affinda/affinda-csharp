...
{
    public partial class ExpectedRemunerationAnnotationV2 : IUtf8JsonSerializable
    {
        ...
        internal static ExpectedRemunerationAnnotationV2 DeserializeExpectedRemunerationAnnotationV2(JsonElement element)
        {
            Optional<ExpectedRemunerationAnnotationV2Parsed> parsed = default;
            int id = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parsed"))
                {
                    ...
                    parsed = ExpectedRemunerationAnnotationV2Parsed.DeserializeExpectedRemunerationAnnotationV2Parsed(property.Value);
                    continue;
                }
            ...
            return new ExpectedRemunerationAnnotationV2(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
