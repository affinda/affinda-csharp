...
{
    /// <summary> The UrlAnnotation. </summary>
    public partial class UrlAnnotation : Annotation
    {
        /// <summary> Initializes a new instance of UrlAnnotation. </summary>
        ...
        internal UrlAnnotation(int id, Rectangle rectangle, IList<Rectangle> rectangles, string document, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool isClientVerified, bool isAutoVerified, string dataPoint, AnnotationContentType contentType, int? parent, IDictionary<string, object> additionalProperties, UrlAnnotationParsed parsed) : base(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, parent, additionalProperties)
        {
            Parsed = parsed;
        }

        /// <summary> Gets or sets the parsed. </summary>
        public UrlAnnotationParsed Parsed { get; set; }
    }
}
