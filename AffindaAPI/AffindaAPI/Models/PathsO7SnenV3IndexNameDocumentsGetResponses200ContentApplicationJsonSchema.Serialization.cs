...
namespace Affinda.API.Models
{
    ...
    {
        internal static PathsO7SnenV3IndexNameDocumentsGetResponses200ContentApplicationJsonSchema DeserializePathsO7SnenV3IndexNameDocumentsGetResponses200ContentApplicationJsonSchema(JsonElement element)
        {
            ...
            return new PathsO7SnenV3IndexNameDocumentsGetResponses200ContentApplicationJsonSchema(Optional.ToNullable(count), next.Value, previous.Value, Optional.ToList(results));
        }
    }
}
