...
{
    public partial class LanguageAnnotationV2 : IUtf8JsonSerializable
    {
        ...
        internal static LanguageAnnotationV2 DeserializeLanguageAnnotationV2(JsonElement element)
        {
            ...
            return new LanguageAnnotationV2(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
