...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountTax : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountTax DeserializeInvoiceDataPaymentAmountTax(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountTax(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
