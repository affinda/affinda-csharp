...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountTax
    {
        internal static InvoiceDataPaymentAmountTax DeserializeInvoiceDataPaymentAmountTax(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountTax(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, classification, additionalProperties, parsed.Value);
        }
    }
}
