...
{
    public partial class InvoiceDataPaymentAmountTax : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountTax DeserializeInvoiceDataPaymentAmountTax(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountTax(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
