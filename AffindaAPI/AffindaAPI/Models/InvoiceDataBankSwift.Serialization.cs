...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankSwift
    {
        internal static InvoiceDataBankSwift DeserializeInvoiceDataBankSwift(JsonElement element)
        {
            ...
            return new InvoiceDataBankSwift(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
