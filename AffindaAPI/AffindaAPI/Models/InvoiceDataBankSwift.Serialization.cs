...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankSwift : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataBankSwift DeserializeInvoiceDataBankSwift(JsonElement element)
        {
            ...
            return new InvoiceDataBankSwift(id, rectangle, rectangles, document.Value, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
