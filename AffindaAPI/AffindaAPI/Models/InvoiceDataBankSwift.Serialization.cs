...
namespace Affinda.API.Models
{
    public partial class InvoiceDataBankSwift
    {
        internal static InvoiceDataBankSwift DeserializeInvoiceDataBankSwift(JsonElement element)
        {
            ...
            return new InvoiceDataBankSwift(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
