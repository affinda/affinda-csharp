...
{
    /// <summary> The CurrencyCodeAnnotation. </summary>
    public partial class CurrencyCodeAnnotation : Annotation
    {
        /// <summary> Initializes a new instance of CurrencyCodeAnnotation. </summary>
        /// <param name="id"></param>
        ...
        internal CurrencyCodeAnnotation(int id, Rectangle rectangle, IList<Rectangle> rectangles, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, bool isClientVerified, bool isAutoVerified, string dataPoint, string contentType, IDictionary<string, object> additionalProperties, DataPointChoice parsed) : base(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties)
        {
            Parsed = parsed;
        }

        /// <summary> Gets or sets the parsed. </summary>
        public DataPointChoice Parsed { get; set; }
    }
}
