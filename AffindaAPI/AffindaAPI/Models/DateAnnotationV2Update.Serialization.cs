...
{
    public partial class DateAnnotationV2Update : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(Parsed))
            {
                if (Parsed != null)
                {
                    ...
                    writer.WriteStringValue(Parsed.Value, "D");
                }
                else
                {
        ...
        internal static DateAnnotationV2Update DeserializeDateAnnotationV2Update(JsonElement element)
        {
            ...
            return new DateAnnotationV2Update(Optional.ToNullable(id), rectangle.Value, Optional.ToList(rectangles), Optional.ToNullable(pageIndex), raw.Value, Optional.ToNullable(confidence), Optional.ToNullable(classificationConfidence), Optional.ToNullable(textExtractionConfidence), Optional.ToNullable(isVerified), Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), dataPoint.Value, contentType.Value, additionalProperties, Optional.ToNullable(parsed));
        }
    }
}
