...
{
    /// <summary> The Components1127QwqSchemasInvoicedataPropertiesBankibanAllof1. </summary>
    public partial class Components1127QwqSchemasInvoicedataPropertiesBankibanAllof1
    {
        ...
        public Components1127QwqSchemasInvoicedataPropertiesBankibanAllof1(string raw)
        {
            Raw = raw;
        }
        ...
        internal Components1127QwqSchemasInvoicedataPropertiesBankibanAllof1(string raw, string parsed)
        {
            Raw = raw;
            Parsed = parsed;
        }
