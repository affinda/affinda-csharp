...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierVat : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierVat DeserializeInvoiceDataSupplierVat(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierVat(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
