...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierVat
    {
        internal static InvoiceDataSupplierVat DeserializeInvoiceDataSupplierVat(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierVat(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
