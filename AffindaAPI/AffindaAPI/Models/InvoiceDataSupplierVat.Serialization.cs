...
{
    public partial class InvoiceDataSupplierVat : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataSupplierVat DeserializeInvoiceDataSupplierVat(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierVat(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
