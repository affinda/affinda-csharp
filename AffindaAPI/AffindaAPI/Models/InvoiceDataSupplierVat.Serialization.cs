...
namespace Affinda.API.Models
{
    public partial class InvoiceDataSupplierVat
    {
        internal static InvoiceDataSupplierVat DeserializeInvoiceDataSupplierVat(JsonElement element)
        {
            ...
            return new InvoiceDataSupplierVat(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
