...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerNumber DeserializeInvoiceDataCustomerNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerNumber(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, additionalProperties, parsed.Value);
        }
    }
}
