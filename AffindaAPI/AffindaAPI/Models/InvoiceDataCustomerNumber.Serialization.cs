...
namespace Affinda.API.Models
{
    public partial class InvoiceDataCustomerNumber
    {
        internal static InvoiceDataCustomerNumber DeserializeInvoiceDataCustomerNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerNumber(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
