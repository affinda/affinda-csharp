...
{
    public partial class InvoiceDataCustomerNumber : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataCustomerNumber DeserializeInvoiceDataCustomerNumber(JsonElement element)
        {
            ...
            return new InvoiceDataCustomerNumber(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
