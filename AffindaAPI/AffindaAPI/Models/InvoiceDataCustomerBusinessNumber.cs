...
namespace Affinda.API.Models
{
    ...
    public partial class InvoiceDataCustomerBusinessNumber : TextAnnotation
    {
        ...
        internal InvoiceDataCustomerBusinessNumber(Rectangle rectangle, int? pageIndex, string raw, float? confidence, float? classificationConfidence, float? textExtractionConfidence, bool isVerified, string classification) : base(rectangle, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, classification)
        {
