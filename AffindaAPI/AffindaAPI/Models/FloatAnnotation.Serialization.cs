...
namespace Affinda.API.Models
{
    public partial class FloatAnnotation : IUtf8JsonSerializable
    {
        ...
        internal static FloatAnnotation DeserializeFloatAnnotation(JsonElement element)
        {
            ...
            return new FloatAnnotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, Optional.ToNullable(parsed));
        }
    }
}
