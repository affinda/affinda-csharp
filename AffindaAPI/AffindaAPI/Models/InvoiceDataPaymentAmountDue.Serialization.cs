...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountDue
    {
        internal static InvoiceDataPaymentAmountDue DeserializeInvoiceDataPaymentAmountDue(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountDue(Optional.ToNullable(id), rectangle, pageIndex, raw, confidence, isVerified, Optional.ToNullable(isClientVerified), Optional.ToNullable(isAutoVerified), classification, additionalProperties, parsed.Value);
        }
    }
}
