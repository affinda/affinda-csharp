...
{
    public partial class InvoiceDataPaymentAmountDue : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountDue DeserializeInvoiceDataPaymentAmountDue(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountDue(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties, parsed.Value);
        }
    }
}
