...
namespace Affinda.API.Models
{
    public partial class InvoiceDataPaymentAmountDue : IUtf8JsonSerializable
    {
        ...
        internal static InvoiceDataPaymentAmountDue DeserializeInvoiceDataPaymentAmountDue(JsonElement element)
        {
            ...
            return new InvoiceDataPaymentAmountDue(id, rectangle, rectangles, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint.Value, contentType, additionalProperties, parsed.Value);
        }
    }
}
