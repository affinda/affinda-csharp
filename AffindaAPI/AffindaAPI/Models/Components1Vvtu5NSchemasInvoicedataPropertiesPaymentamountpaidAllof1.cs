...
{
    /// <summary> The Components1Vvtu5NSchemasInvoicedataPropertiesPaymentamountpaidAllof1. </summary>
    public partial class Components1Vvtu5NSchemasInvoicedataPropertiesPaymentamountpaidAllof1
    {
        ...
        public Components1Vvtu5NSchemasInvoicedataPropertiesPaymentamountpaidAllof1(string raw)
        {
            Raw = raw;
        }
        ...
        internal Components1Vvtu5NSchemasInvoicedataPropertiesPaymentamountpaidAllof1(string raw, string parsed)
        {
            Raw = raw;
            Parsed = parsed;
        }
