...
{
    /// <summary> The ExtractorBaseExtractor. </summary>
    public partial class ExtractorBaseExtractor
    {
        ...
        internal ExtractorBaseExtractor(int id, string identifier, string name, string namePlural, bool validatable)
        {
            if (identifier == null)
            {
        ...
        internal ExtractorBaseExtractor(int id, string identifier, string name, string namePlural, bool validatable, bool? isCustom, DateTimeOffset? createdDt)
        {
            Id = id;
            Identifier = identifier;
            Name = name;
