...
namespace Affinda.API.Models
{
    public partial class Annotation : IUtf8JsonSerializable
    {
        ...
        internal static Annotation DeserializeAnnotation(JsonElement element)
        {
            ...
            return new Annotation(id, rectangle, rectangles, document, pageIndex, raw, confidence, classificationConfidence, textExtractionConfidence, isVerified, isClientVerified, isAutoVerified, dataPoint, contentType, Optional.ToNullable(parent), additionalProperties);
        }
    }
}
