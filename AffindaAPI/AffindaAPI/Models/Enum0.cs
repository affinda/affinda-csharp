...
namespace Affinda.API.Models
{
    ...
    public readonly partial struct Enum0 : IEquatable<Enum0>
    {
        ...
        public static Enum0 None { get; } = new Enum0(NoneValue);
        /// <summary> Low. </summary>
        public static Enum0 Low { get; } = new Enum0(LowValue);
        /// <summary> Mid. </summary>
        public static Enum0 Mid { get; } = new Enum0(MidValue);
        /// <summary> Upper. </summary>
        public static Enum0 Upper { get; } = new Enum0(UpperValue);
        /// <summary> Determines if two <see cref="Enum0"/> values are the same. </summary>
