...
{
    public partial class TextAnnotationV2Update : IUtf8JsonSerializable
    {
        ...
        internal static TextAnnotationV2Update DeserializeTextAnnotationV2Update(JsonElement element)
        {
