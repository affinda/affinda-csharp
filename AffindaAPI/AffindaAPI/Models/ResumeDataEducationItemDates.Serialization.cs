...
{
    public partial class ResumeDataEducationItemDates : IUtf8JsonSerializable
    {
        ...
        internal static ResumeDataEducationItemDates DeserializeResumeDataEducationItemDates(JsonElement element)
        {
            ...
            return new ResumeDataEducationItemDates(Optional.ToNullable(completionDate), Optional.ToNullable(isCurrent), Optional.ToNullable(startDate));
        }
    }
}
