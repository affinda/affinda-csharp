...
namespace affinda.Models
{
    ...
    {
        internal static Paths4Fg3YrReformattedResumesGetResponses200ContentApplicationJsonSchema DeserializePaths4Fg3YrReformattedResumesGetResponses200ContentApplicationJsonSchema(JsonElement element)
        {
            ...
            return new Paths4Fg3YrReformattedResumesGetResponses200ContentApplicationJsonSchema(Optional.ToNullable(count), next.Value, previous.Value, Optional.ToList(results));
        }
    }
}
